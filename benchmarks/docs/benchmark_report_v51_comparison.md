...
| conversational-qa | accuracy_pct | 27.500 | 95.4 (OMEGA) | -67.9 |
| intent-routing | avg_intent_hit | 0.700 | — | — |
| kg-reasoning | avg_latency_ms | 0.132 | — | — |
| memory-lifecycle | create.success_rate | 1.000 | — | — |
| performance | search.p50_ms | 0.202 | — | — |
| proactive-optimization | L0.avg_tokens | 113.000 | — | — |
| retrieval | beir_scifact.recall@5 | 0.033 | 72.31 (NV-Embed-v2) | -72.3 |
| scope-isolation | leak_rate | 0.000 | — | — |
| session-lifecycle | success_rate | 1.000 | — | — |
| token-efficiency | context_l0.avg_tokens | 362.500 | 1294 (Memori) | -931.5 |
...
| Metric | Value |
|--------|-------|
| causal_chain_construction | count=30, avg_node_latency_ms=0.48 |
| causal_path_depth_2 | paths_found=1, latency_ms=0.14 |
| causal_path_depth_3 | paths_found=2, latency_ms=0.11 |
| causal_path_depth_4 | paths_found=5, latency_ms=0.20 |
| causal_path_depth_10 | paths_found=9, latency_ms=0.30 |
...
| causal_chain_construction.avg_node_latency_ms | 0.698 | 0.483 | -0.215 |
| causal_path_depth_2.paths_found | 1 | 1 | = |
| causal_path_depth_2.latency_ms | 0.254 | 0.140 | -0.114 |
| causal_path_depth_3.paths_found | 2 | 2 | = |
| causal_path_depth_3.latency_ms | 0.265 | 0.113 | -0.152 |
| causal_path_depth_4.paths_found | 5 | 5 | = |
| causal_path_depth_4.latency_ms | 0.243 | 0.204 | -0.039 |
| causal_path_depth_10.paths_found | 9 | 9 | = |
| causal_path_depth_10.latency_ms | 0.497 | 0.301 | -0.196 |
...
| Metric | Score | Target |
|--------|-------|--------|
| faithfulness | 1.000 | 0.85 (+0.15) |
| answer_relevancy | 0.700 | 0.80 (-0.10) |
| context_precision | 0.425 | 0.65 (-0.23) |
| context_recall | 0.405 | 0.75 (-0.34) |
...
|--------|------|---------|-------|
| count | 40 | 40 | = |
| f1 | 0.204 | 0.188 | -0.016 |
| bleu1 | 0.165 | 0.153 | -0.011 |
| llm_score | 2.225 | 2.150 | -0.075 |
| accuracy_pct | 30.000 | 27.500 | -2.500 |
| context_hit_rate | 1.000 | 1.000 | = |
| mean | 0.204 | 0.188 | -0.016 |
| std | 0.330 | 0.325 | -0.005 |
| ci95_low | 0.101 | 0.087 | -0.014 |
| ci95_high | 0.306 | 0.288 | -0.017 |

### intent-routing

| Metric | Value |
|--------|-------|
| intent_factual | query_count=5, hit_rate=0.68, accuracy_pct=0.00, avg_latency_ms=81.01 |
| intent_temporal | query_count=5, hit_rate=0.76, accuracy_pct=20.00, avg_latency_ms=75.50 |
| intent_multi_hop | query_count=5, hit_rate=1.00, accuracy_pct=20.00, avg_latency_ms=94.94 |
| intent_preference | query_count=5, hit_rate=0.60, accuracy_pct=0.00, avg_latency_ms=136.07 |
| intent_aggregation | query_count=5, hit_rate=0.46, accuracy_pct=0.00, avg_latency_ms=89.35 |
...
| intent_factual.hit_rate | 0.680 | 0.680 | = |
| intent_factual.accuracy_pct | 0.000 | 0.000 | = |
| intent_factual.avg_latency_ms | 96.520 | 81.010 | -15.510 |
| intent_temporal.query_count | 5 | 5 | = |
| intent_temporal.hit_rate | 0.760 | 0.760 | = |
| intent_temporal.accuracy_pct | 20.000 | 20.000 | = |
| intent_temporal.avg_latency_ms | 99.020 | 75.500 | -23.520 |
| intent_multi_hop.query_count | 5 | 5 | = |
| intent_multi_hop.hit_rate | 1.000 | 1.000 | = |
| intent_multi_hop.accuracy_pct | 20.000 | 20.000 | = |
| intent_multi_hop.avg_latency_ms | 108.560 | 94.940 | -13.620 |
| intent_preference.query_count | 5 | 5 | = |
| intent_preference.hit_rate | 0.600 | 0.600 | = |
| intent_preference.accuracy_pct | 0.000 | 0.000 | = |
| intent_preference.avg_latency_ms | 137.830 | 136.070 | -1.760 |
| intent_aggregation.query_count | 5 | 5 | = |
| intent_aggregation.hit_rate | 0.500 | 0.460 | -0.040 |
| intent_aggregation.accuracy_pct | 0.000 | 0.000 | = |
| intent_aggregation.avg_latency_ms | 100.970 | 89.350 | -11.620 |
| intent_vs_no_intent_factual.with_intent_hits | 24 | 24 | = |
| intent_vs_no_intent_factual.without_intent_hits | 24 | 24 | = |
| intent_vs_no_intent_factual.improvement_pct | 0.000 | 0.000 | = |
| intent_vs_no_intent_temporal.with_intent_hits | 30 | 30 | = |
| intent_vs_no_intent_temporal.without_intent_hits | 30 | 30 | = |
| intent_vs_no_intent_temporal.improvement_pct | 0.000 | 0.000 | = |
| intent_vs_no_intent_multi_hop.with_intent_hits | 30 | 30 | = |
| intent_vs_no_intent_multi_hop.without_intent_hits | 30 | 30 | = |
...
| causal_latency_ms | 0.258 | 0.104 | -0.154 |

### memory-lifecycle

| Metric | Value |
|--------|-------|
| create | count=100, success_rate=1.00, avg_latency_ms=2.94 |
| read | count=100, success_rate=1.00, avg_latency_ms=0.15 |
| search | count=20, hit_rate=0.90, avg_latency_ms=12.24 |
| update | count=20, success_rate=1.00, avg_latency_ms=3.59 |
| delete | count=10, success_rate=1.00, avg_latency_ms=0.04, search_gone_rate=0.70 |
| batch_create | count=50, success_rate=1.00, avg_latency_ms=408.57 |
...
| create.avg_latency_ms | 13.095 | 2.935 | -10.160 |
| read.count | 100 | 100 | = |
| read.success_rate | 1.000 | 1.000 | = |
| read.avg_latency_ms | 0.204 | 0.152 | -0.052 |
| search.count | 20 | 20 | = |
| search.hit_rate | 0.000 | 0.900 | +0.900 |
| search.avg_latency_ms | 81.610 | 12.241 | -69.369 |
| update.count | 20 | 20 | = |
| update.success_rate | 1.000 | 1.000 | = |
| update.avg_latency_ms | 8.506 | 3.591 | -4.915 |
| delete.count | 10 | 10 | = |
| delete.success_rate | 0.000 | 1.000 | +1.000 |
| delete.avg_latency_ms | 0.001 | 0.035 | +0.034 |
| delete.search_gone_rate | 1.000 | 0.700 | -0.300 |
| batch_create.count | 50 | 50 | = |
| batch_create.success_rate | 1.000 | 1.000 | = |
| batch_create.avg_latency_ms | 350.447 | 408.574 | +58.127 |
...
| Metric | Value |
|--------|-------|
| cas_write | qps=241.30, p50_ms=3.63, p95_ms=6.24, p99_ms=12.45 |
| search | qps=3034.10, p50_ms=0.20, p95_ms=0.42, p99_ms=0.49 |
| memory_recall | qps=10114.50, p50_ms=0.10, p95_ms=0.12, p99_ms=0.29 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| cas_write.qps | 21.300 | 241.300 | +220.000 |
| cas_write.p50_ms | 17.345 | 3.633 | -13.711 |
| cas_write.p95_ms | 26.518 | 6.243 | -20.275 |
| cas_write.p99_ms | 1696.189 | 12.450 | -1683.740 |
| search.qps | 1375.500 | 3034.100 | +1658.600 |
| search.p50_ms | 0.079 | 0.202 | +0.124 |
| search.p95_ms | 0.152 | 0.419 | +0.267 |
| search.p99_ms | 0.562 | 0.488 | -0.075 |
| memory_recall.qps | 2218.700 | 10114.500 | +7895.800 |
| memory_recall.p50_ms | 0.446 | 0.102 | -0.344 |
| memory_recall.p95_ms | 0.513 | 0.116 | -0.397 |
| memory_recall.p99_ms | 2.602 | 0.288 | -2.314 |
...
| context_l2 | avg_tokens_per_query=1058.60, hit_rate=1.00, pct_of_full=4.07 |
| repeated_query_latency | cold_avg_ms=19.29, warm_avg_ms=0.11, speedup_pct=99.40, cache_bust_queries=10 |
...
| context_l1.avg_tokens_per_query | 352.400 | 352.400 | = |
| context_l1.hit_rate | 1.000 | 1.000 | = |
| context_l1.pct_of_full | 1.350 | 1.350 | = |
| context_l2.avg_tokens_per_query | 1058.800 | 1058.600 | -0.200 |
| context_l2.hit_rate | 1.000 | 1.000 | = |
| context_l2.pct_of_full | 4.070 | 4.070 | = |
| repeated_query_latency.cold_avg_ms | 40.510 | 19.290 | -21.220 |
| repeated_query_latency.warm_avg_ms | 0.270 | 0.110 | -0.160 |
| repeated_query_latency.speedup_pct | 99.300 | 99.400 | +0.100 |
| repeated_query_latency.cache_bust_queries | 10 | 10 | = |
| pattern_detection.items_created | 30 | 30 | = |
| pattern_detection.search_hits | 20 | 20 | = |
| pattern_detection.recall_hits | 0 | 0 | = |
| pattern_detection.search_recall_rate | 0.667 | 0.667 | = |

### retrieval

| Metric | Value |
|--------|-------|
| beir_scifact | count=30, recall@5=0.03, recall@10=0.20 |
...
| beir_scifact.recall@5 | 0.557 | 0.033 | -0.524 |
| beir_scifact.recall@10 | 0.770 | 0.200 | -0.570 |
...
| Metric | Value |
|--------|-------|
| session_lifecycle | count=20, success_rate=1.00, avg_start_latency_ms=41.75, avg_end_latency_ms=0.67 |
...
| warm_context_delta | session1_items=10, cross_session_hit_rate=0.00, assembly_latency_ms=30.49 |
...
| session_lifecycle.avg_start_latency_ms | 127.926 | 41.745 | -86.181 |
| session_lifecycle.avg_end_latency_ms | 0 | 0.670 | +0.670 |
...
| warm_context_delta.assembly_latency_ms | 138.174 | 30.487 | -107.687 |

### token-efficiency

| Metric | Value |
|--------|-------|
| context_l0 | avg_tokens_per_query=362.50, pct_of_full_context=1.39, vs_memori_ratio=0.28 |
| context_l1 | avg_tokens_per_query=575.80, pct_of_full_context=2.21, vs_memori_ratio=0.44 |
| context_l2 | avg_tokens_per_query=1577.80, pct_of_full_context=6.06, vs_memori_ratio=1.22 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| context_l0.avg_tokens_per_query | 350.000 | 362.500 | +12.500 |
| context_l0.pct_of_full_context | 1.340 | 1.390 | +0.050 |
| context_l0.vs_memori_ratio | 0.270 | 0.280 | +0.010 |
| context_l1.avg_tokens_per_query | 575.800 | 575.800 | = |
| context_l1.pct_of_full_context | 2.210 | 2.210 | = |
| context_l1.vs_memori_ratio | 0.440 | 0.440 | = |
| context_l2.avg_tokens_per_query | 1689.800 | 1577.800 | -112.000 |
| context_l2.pct_of_full_context | 6.490 | 6.060 | -0.430 |
| context_l2.vs_memori_ratio | 1.310 | 1.220 | -0.090 |
...
|---|-------|----------|--------|-------|
| A1 | token_scarcity | token-efficiency | 362 tok/query (under Memori) | 2/2 |
| A2 | intent_before_action | intent-routing, conversational-qa | accuracy 27.5% | 0/2 |
...
| A6 | semantics_before_structure | retrieval | beir_scifact recall@5 0.033 | 0/2 |
