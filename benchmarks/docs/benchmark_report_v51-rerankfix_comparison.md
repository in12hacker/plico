...
| conversational-qa | accuracy_pct | 40.000 | 95.4 (OMEGA) | -55.4 |
| intent-routing | avg_intent_hit | 0.664 | — | — |
| kg-reasoning | avg_latency_ms | 0.219 | — | — |
| memory-lifecycle | create.success_rate | 1.000 | — | — |
| performance | search.p50_ms | 79.368 | — | — |
| proactive-optimization | L0.avg_tokens | 113.000 | — | — |
| retrieval | beir_scifact.recall@5 | 0.460 | 72.31 (NV-Embed-v2) | -71.9 |
| scope-isolation | leak_rate | 0.000 | — | — |
| session-lifecycle | success_rate | 1.000 | — | — |
| token-efficiency | context_l0.avg_tokens | 514.400 | 1294 (Memori) | -779.6 |
...
| Metric | Value |
|--------|-------|
| causal_chain_construction | count=30, avg_node_latency_ms=0.50 |
| causal_path_depth_2 | paths_found=1, latency_ms=0.24 |
| causal_path_depth_3 | paths_found=2, latency_ms=0.24 |
| causal_path_depth_4 | paths_found=5, latency_ms=0.16 |
| causal_path_depth_10 | paths_found=9, latency_ms=0.19 |
...
| causal_chain_construction.avg_node_latency_ms | 0.698 | 0.503 | -0.196 |
| causal_path_depth_2.paths_found | 1 | 1 | = |
| causal_path_depth_2.latency_ms | 0.254 | 0.238 | -0.016 |
| causal_path_depth_3.paths_found | 2 | 2 | = |
| causal_path_depth_3.latency_ms | 0.265 | 0.236 | -0.029 |
| causal_path_depth_4.paths_found | 5 | 5 | = |
| causal_path_depth_4.latency_ms | 0.243 | 0.162 | -0.081 |
| causal_path_depth_10.paths_found | 9 | 9 | = |
| causal_path_depth_10.latency_ms | 0.497 | 0.193 | -0.304 |
...
| context_precision | 0.715 | 0.65 (+0.06) |
...
|--------|------|---------|-------|
| count | 40 | 40 | = |
| f1 | 0.204 | 0.263 | +0.059 |
| bleu1 | 0.165 | 0.223 | +0.058 |
| llm_score | 2.225 | 2.625 | +0.400 |
| accuracy_pct | 30.000 | 40.000 | +10.000 |
| context_hit_rate | 1.000 | 1.000 | = |
| mean | 0.204 | 0.263 | +0.059 |
| std | 0.330 | 0.361 | +0.032 |
| ci95_low | 0.101 | 0.151 | +0.050 |
| ci95_high | 0.306 | 0.375 | +0.069 |

### intent-routing

| Metric | Value |
|--------|-------|
| intent_factual | query_count=5, hit_rate=0.40, accuracy_pct=0.00, avg_latency_ms=441.72 |
| intent_temporal | query_count=5, hit_rate=0.60, accuracy_pct=0.00, avg_latency_ms=445.61 |
| intent_multi_hop | query_count=5, hit_rate=0.92, accuracy_pct=20.00, avg_latency_ms=381.04 |
| intent_preference | query_count=5, hit_rate=0.80, accuracy_pct=0.00, avg_latency_ms=428.37 |
| intent_aggregation | query_count=5, hit_rate=0.60, accuracy_pct=0.00, avg_latency_ms=432.88 |
...
| intent_factual.avg_latency_ms | 96.520 | 441.720 | +345.200 |
...
| intent_aggregation.avg_latency_ms | 100.970 | 432.880 | +331.910 |
...
| avg_latency_ms | 0.356 | 0.219 | -0.137 |
| path_validity_rate | 1.000 | 1.000 | = |
| total_paths | 11 | 11 | = |
| valid_paths | 11 | 11 | = |
| causal_paths_found | 1 | 1 | = |
| causal_valid_paths | 1 | 1 | = |
| causal_latency_ms | 0.258 | 0.136 | -0.122 |

### memory-lifecycle

| Metric | Value |
|--------|-------|
| create | count=100, success_rate=1.00, avg_latency_ms=2.98 |
| read | count=100, success_rate=1.00, avg_latency_ms=0.10 |
| search | count=20, hit_rate=1.00, avg_latency_ms=63.18 |
| update | count=20, success_rate=1.00, avg_latency_ms=3.33 |
| delete | count=10, success_rate=1.00, avg_latency_ms=0.04, search_gone_rate=0.00 |
| batch_create | count=50, success_rate=1.00, avg_latency_ms=367.31 |
...
| create.avg_latency_ms | 13.095 | 2.981 | -10.114 |
| read.count | 100 | 100 | = |
| read.success_rate | 1.000 | 1.000 | = |
| read.avg_latency_ms | 0.204 | 0.103 | -0.101 |
| search.count | 20 | 20 | = |
| search.hit_rate | 0.000 | 1.000 | +1.000 |
| search.avg_latency_ms | 81.610 | 63.183 | -18.427 |
| update.count | 20 | 20 | = |
| update.success_rate | 1.000 | 1.000 | = |
| update.avg_latency_ms | 8.506 | 3.329 | -5.177 |
| delete.count | 10 | 10 | = |
...
| batch_create.avg_latency_ms | 350.447 | 367.305 | +16.858 |
...
| Metric | Value |
|--------|-------|
| cas_write | qps=223.70, p50_ms=3.63, p95_ms=7.17, p99_ms=21.89 |
| search | qps=12.10, p50_ms=79.37, p95_ms=124.60, p99_ms=136.49 |
| memory_recall | qps=11533.60, p50_ms=0.08, p95_ms=0.09, p99_ms=0.27 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| cas_write.qps | 21.300 | 223.700 | +202.400 |
| cas_write.p50_ms | 17.345 | 3.635 | -13.710 |
| cas_write.p95_ms | 26.518 | 7.170 | -19.348 |
| cas_write.p99_ms | 1696.189 | 21.895 | -1674.294 |
| search.qps | 1375.500 | 12.100 | -1363.400 |
| search.p50_ms | 0.079 | 79.368 | +79.290 |
| search.p95_ms | 0.152 | 124.604 | +124.452 |
| search.p99_ms | 0.562 | 136.491 | +135.929 |
| memory_recall.qps | 2218.700 | 11533.600 | +9314.900 |
| memory_recall.p50_ms | 0.446 | 0.082 | -0.364 |
| memory_recall.p95_ms | 0.513 | 0.087 | -0.426 |
| memory_recall.p99_ms | 2.602 | 0.274 | -2.328 |
...
| context_l2 | avg_tokens_per_query=568.90, hit_rate=1.00, pct_of_full=2.19 |
| repeated_query_latency | cold_avg_ms=429.05, warm_avg_ms=432.30, speedup_pct=-0.80, cache_bust_queries=10 |
...
| context_l2.avg_tokens_per_query | 1058.800 | 568.900 | -489.900 |
| context_l2.hit_rate | 1.000 | 1.000 | = |
| context_l2.pct_of_full | 4.070 | 2.190 | -1.880 |
| repeated_query_latency.cold_avg_ms | 40.510 | 429.050 | +388.540 |
| repeated_query_latency.warm_avg_ms | 0.270 | 432.300 | +432.030 |
| repeated_query_latency.speedup_pct | 99.300 | -0.800 | -100.100 |
...
| Metric | Value |
|--------|-------|
| beir_scifact | count=30, recall@5=0.46, recall@10=0.56 |
...
| beir_scifact.recall@5 | 0.557 | 0.460 | -0.097 |
| beir_scifact.recall@10 | 0.770 | 0.560 | -0.210 |
...
| Metric | Value |
|--------|-------|
| session_lifecycle | count=20, success_rate=1.00, avg_start_latency_ms=44.18, avg_end_latency_ms=0.84 |
...
| warm_context_delta | session1_items=10, cross_session_hit_rate=0.00, assembly_latency_ms=36.77 |
...
| session_lifecycle.avg_start_latency_ms | 127.926 | 44.183 | -83.744 |
| session_lifecycle.avg_end_latency_ms | 0 | 0.842 | +0.842 |
...
| warm_context_delta.assembly_latency_ms | 138.174 | 36.768 | -101.406 |

### token-efficiency

| Metric | Value |
|--------|-------|
| context_l0 | avg_tokens_per_query=514.40, pct_of_full_context=1.98, vs_memori_ratio=0.40 |
| context_l1 | avg_tokens_per_query=874.50, pct_of_full_context=3.36, vs_memori_ratio=0.68 |
| context_l2 | avg_tokens_per_query=1789.60, pct_of_full_context=6.87, vs_memori_ratio=1.38 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| context_l0.avg_tokens_per_query | 350.000 | 514.400 | +164.400 |
| context_l0.pct_of_full_context | 1.340 | 1.980 | +0.640 |
| context_l0.vs_memori_ratio | 0.270 | 0.400 | +0.130 |
| context_l1.avg_tokens_per_query | 575.800 | 874.500 | +298.700 |
| context_l1.pct_of_full_context | 2.210 | 3.360 | +1.150 |
| context_l1.vs_memori_ratio | 0.440 | 0.680 | +0.240 |
| context_l2.avg_tokens_per_query | 1689.800 | 1789.600 | +99.800 |
| context_l2.pct_of_full_context | 6.490 | 6.870 | +0.380 |
| context_l2.vs_memori_ratio | 1.310 | 1.380 | +0.070 |
...
|---|-------|----------|--------|-------|
| A1 | token_scarcity | token-efficiency | 514 tok/query (under Memori) | 2/2 |
| A2 | intent_before_action | intent-routing, conversational-qa | accuracy 40.0% | 1/2 |
...
| A6 | semantics_before_structure | retrieval | beir_scifact recall@5 0.460 | 1/2 |
