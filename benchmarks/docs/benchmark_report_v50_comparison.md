...
> Generated: 2026-05-15 15:42:40
> Compared against: v44
...
| causal-reasoning | cause_finds_effect | 0.400 | — | — |
| conversational-qa | accuracy_pct | 30.000 | 95.4 (OMEGA) | -65.4 |
| conversational-qa | accuracy_pct | 30.000 | 95.4 (OMEGA) | -65.4 |
| intent-routing | avg_intent_hit | 0.708 | — | — |
| intent-routing | avg_intent_hit | 0.696 | — | — |
| kg-reasoning | avg_latency_ms | 0.356 | — | — |
| kg-reasoning | avg_latency_ms | 0.812 | — | — |
| memory-lifecycle | create.success_rate | 1.000 | — | — |
| memory-lifecycle | create.success_rate | 1.000 | — | — |
| performance | search.p50_ms | 0.079 | — | — |
| performance | search.p50_ms | 0.226 | — | — |
| proactive-optimization | L0.avg_tokens | 113.000 | — | — |
| proactive-optimization | L0.avg_tokens | 113.000 | — | — |
| retrieval | recall@5 | 0 | 72.31 (NV-Embed-v2) | -72.3 |
| retrieval | beir_scifact.recall@5 | 0.557 | 72.31 (NV-Embed-v2) | -71.8 |
| scope-isolation | leak_rate | 0.000 | — | — |
| scope-isolation | leak_rate | 0.667 | — | — |
| session-lifecycle | success_rate | 0.000 | — | — |
| session-lifecycle | success_rate | 1.000 | — | — |
| token-efficiency | context_l0.avg_tokens | 350.000 | 1294 (Memori) | -944.0 |
| token-efficiency | context_l0.avg_tokens | 312.500 | 1294 (Memori) | -981.5 |
...
| Metric | Value |
|--------|-------|
| causal_chain_construction | count=30, avg_node_latency_ms=0.70 |
| causal_path_depth_2 | paths_found=1, latency_ms=0.25 |
| causal_path_depth_3 | paths_found=2, latency_ms=0.26 |
| causal_path_depth_4 | paths_found=5, latency_ms=0.24 |
| causal_path_depth_10 | paths_found=9, latency_ms=0.50 |
| causal_retrieval | count=5, cause_finds_effect_rate=0.00, effect_finds_cause_rate=0.00, bidirectional_rate=0.00 |
...
|--------|------|---------|-------|
| causal_chain_construction.count | — | 30 | — |
| causal_chain_construction.avg_node_latency_ms | — | 0.698 | — |
| causal_path_depth_2.paths_found | — | 1 | — |
| causal_path_depth_2.latency_ms | — | 0.254 | — |
| causal_path_depth_3.paths_found | — | 2 | — |
| causal_path_depth_3.latency_ms | — | 0.265 | — |
| causal_path_depth_4.paths_found | — | 5 | — |
| causal_path_depth_4.latency_ms | — | 0.243 | — |
| causal_path_depth_10.paths_found | — | 9 | — |
| causal_path_depth_10.latency_ms | — | 0.497 | — |
| causal_retrieval.count | — | 5 | — |
| causal_retrieval.cause_finds_effect_rate | — | 0.000 | — |
| causal_retrieval.effect_finds_cause_rate | — | 0.000 | — |
| causal_retrieval.bidirectional_rate | — | 0.000 | — |
| causal_chain_construction.count | — | 30 | — |
| causal_chain_construction.avg_node_latency_ms | — | 3.222 | — |
| causal_path_depth_2.paths_found | — | 1 | — |
| causal_path_depth_2.latency_ms | — | 0.160 | — |
| causal_path_depth_3.paths_found | — | 2 | — |
| causal_path_depth_3.latency_ms | — | 0.131 | — |
| causal_path_depth_4.paths_found | — | 5 | — |
| causal_path_depth_4.latency_ms | — | 0.276 | — |
| causal_path_depth_10.paths_found | — | 9 | — |
| causal_path_depth_10.latency_ms | — | 0.339 | — |
| causal_retrieval.count | — | 5 | — |
| causal_retrieval.cause_finds_effect_rate | — | 0.400 | — |
| causal_retrieval.effect_finds_cause_rate | — | 0.400 | — |
| causal_retrieval.bidirectional_rate | — | 0.400 | — |
| causal_retrieval.accuracy_pct | — | 0.000 | — |

### causal-reasoning

| Metric | Value |
|--------|-------|
| causal_chain_construction | count=30, avg_node_latency_ms=3.22 |
| causal_path_depth_2 | paths_found=1, latency_ms=0.16 |
| causal_path_depth_3 | paths_found=2, latency_ms=0.13 |
| causal_path_depth_4 | paths_found=5, latency_ms=0.28 |
| causal_path_depth_10 | paths_found=9, latency_ms=0.34 |
| causal_retrieval | count=5, cause_finds_effect_rate=0.40, effect_finds_cause_rate=0.40, bidirectional_rate=0.40, accuracy_pct=0.00 |
...
|--------|------|---------|-------|
| count | 40 | 40 | = |
| f1 | 0.206 | 0.204 | -0.002 |
| bleu1 | 0.167 | 0.165 | -0.003 |
| llm_score | 2.325 | 2.225 | -0.100 |
| accuracy_pct | — | 30.000 | — |
| context_hit_rate | 1.000 | 1.000 | = |
| mean | 0.206 | 0.204 | -0.002 |
| std | 0.329 | 0.330 | +0.001 |
| ci95_low | 0.104 | 0.101 | -0.003 |
| ci95_high | 0.308 | 0.306 | -0.002 |
| count | 40 | 40 | = |
| f1 | 0.206 | 0.213 | +0.007 |
| bleu1 | 0.167 | 0.178 | +0.011 |
| llm_score | 2.325 | 2.350 | +0.025 |
| accuracy_pct | — | 30.000 | — |
| context_hit_rate | 1.000 | 1.000 | = |
| mean | 0.206 | 0.213 | +0.007 |
| std | 0.329 | 0.338 | +0.010 |
| ci95_low | 0.104 | 0.108 | +0.003 |
| ci95_high | 0.308 | 0.317 | +0.010 |
...
| Metric | Score | Target |
|--------|-------|--------|
| faithfulness | 0.950 | 0.85 (+0.10) |
| answer_relevancy | 0.650 | 0.80 (-0.15) |
| context_precision | 0.450 | 0.65 (-0.20) |
| context_recall | 0.390 | 0.75 (-0.36) |
...
| Metric | Value |
|--------|-------|
| intent_factual | query_count=5, hit_rate=0.68, avg_latency_ms=96.52 |
| intent_temporal | query_count=5, hit_rate=0.76, avg_latency_ms=99.02 |
| intent_multi_hop | query_count=5, hit_rate=1.00, avg_latency_ms=108.56 |
| intent_preference | query_count=5, hit_rate=0.60, avg_latency_ms=137.83 |
| intent_aggregation | query_count=5, hit_rate=0.50, avg_latency_ms=100.97 |
| intent_vs_no_intent_factual | with_intent_hits=24, without_intent_hits=24, improvement_pct=0.00 |
| intent_vs_no_intent_temporal | with_intent_hits=30, without_intent_hits=30, improvement_pct=0.00 |
| intent_vs_no_intent_multi_hop | with_intent_hits=30, without_intent_hits=30, improvement_pct=0.00 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| intent_factual.query_count | — | 5 | — |
| intent_factual.hit_rate | — | 0.680 | — |
| intent_factual.avg_latency_ms | — | 96.520 | — |
| intent_temporal.query_count | — | 5 | — |
| intent_temporal.hit_rate | — | 0.760 | — |
| intent_temporal.avg_latency_ms | — | 99.020 | — |
| intent_multi_hop.query_count | — | 5 | — |
| intent_multi_hop.hit_rate | — | 1.000 | — |
| intent_multi_hop.avg_latency_ms | — | 108.560 | — |
| intent_preference.query_count | — | 5 | — |
| intent_preference.hit_rate | — | 0.600 | — |
| intent_preference.avg_latency_ms | — | 137.830 | — |
| intent_aggregation.query_count | — | 5 | — |
| intent_aggregation.hit_rate | — | 0.500 | — |
| intent_aggregation.avg_latency_ms | — | 100.970 | — |
| intent_vs_no_intent_factual.with_intent_hits | — | 24 | — |
| intent_vs_no_intent_factual.without_intent_hits | — | 24 | — |
| intent_vs_no_intent_factual.improvement_pct | — | 0.000 | — |
| intent_vs_no_intent_temporal.with_intent_hits | — | 30 | — |
| intent_vs_no_intent_temporal.without_intent_hits | — | 30 | — |
| intent_vs_no_intent_temporal.improvement_pct | — | 0.000 | — |
| intent_vs_no_intent_multi_hop.with_intent_hits | — | 30 | — |
| intent_vs_no_intent_multi_hop.without_intent_hits | — | 30 | — |
| intent_vs_no_intent_multi_hop.improvement_pct | — | 0.000 | — |
| intent_vs_no_intent_preference.with_intent_hits | — | 20 | — |
| intent_vs_no_intent_preference.without_intent_hits | — | 20 | — |
| intent_vs_no_intent_preference.improvement_pct | — | 0.000 | — |
| intent_vs_no_intent_aggregation.with_intent_hits | — | 20 | — |
| intent_vs_no_intent_aggregation.without_intent_hits | — | 20 | — |
| intent_vs_no_intent_aggregation.improvement_pct | — | 0.000 | — |
| intent_factual.query_count | — | 5 | — |
| intent_factual.hit_rate | — | 0.680 | — |
| intent_factual.accuracy_pct | — | 0.000 | — |
| intent_factual.avg_latency_ms | — | 98.750 | — |
| intent_temporal.query_count | — | 5 | — |
| intent_temporal.hit_rate | — | 0.760 | — |
| intent_temporal.accuracy_pct | — | 20.000 | — |
| intent_temporal.avg_latency_ms | — | 90.570 | — |
| intent_multi_hop.query_count | — | 5 | — |
| intent_multi_hop.hit_rate | — | 0.980 | — |
| intent_multi_hop.accuracy_pct | — | 20.000 | — |
| intent_multi_hop.avg_latency_ms | — | 120.740 | — |
| intent_preference.query_count | — | 5 | — |
| intent_preference.hit_rate | — | 0.600 | — |
| intent_preference.accuracy_pct | — | 0.000 | — |
| intent_preference.avg_latency_ms | — | 160.830 | — |
| intent_aggregation.query_count | — | 5 | — |
| intent_aggregation.hit_rate | — | 0.460 | — |
| intent_aggregation.accuracy_pct | — | 0.000 | — |
| intent_aggregation.avg_latency_ms | — | 110.400 | — |
| intent_vs_no_intent_factual.with_intent_hits | — | 24 | — |
| intent_vs_no_intent_factual.without_intent_hits | — | 24 | — |
| intent_vs_no_intent_factual.improvement_pct | — | 0.000 | — |
| intent_vs_no_intent_temporal.with_intent_hits | — | 30 | — |
...
| Metric | Value |
|--------|-------|
| intent_factual | query_count=5, hit_rate=0.68, accuracy_pct=0.00, avg_latency_ms=98.75 |
| intent_temporal | query_count=5, hit_rate=0.76, accuracy_pct=20.00, avg_latency_ms=90.57 |
| intent_multi_hop | query_count=5, hit_rate=0.98, accuracy_pct=20.00, avg_latency_ms=120.74 |
| intent_preference | query_count=5, hit_rate=0.60, accuracy_pct=0.00, avg_latency_ms=160.83 |
| intent_aggregation | query_count=5, hit_rate=0.46, accuracy_pct=0.00, avg_latency_ms=110.40 |
| intent_vs_no_intent_factual | with_intent_hits=24, without_intent_hits=24, improvement_pct=0.00 |
| intent_vs_no_intent_temporal | with_intent_hits=30, without_intent_hits=30, improvement_pct=0.00 |
| intent_vs_no_intent_multi_hop | with_intent_hits=30, without_intent_hits=30, improvement_pct=0.00 |
| intent_vs_no_intent_preference | with_intent_hits=20, without_intent_hits=20, improvement_pct=0.00 |
...
| avg_latency_ms | 0.486 | 0.356 | -0.130 |
| path_validity_rate | — | 1.000 | — |
| total_paths | — | 11 | — |
| valid_paths | — | 11 | — |
| causal_paths_found | — | 1 | — |
...
| avg_paths_unweighted | 2.500 | 2.500 | = |
| avg_paths_weighted | 0.000 | 0.000 | = |
| avg_latency_ms | 0.486 | 0.812 | +0.326 |
| path_validity_rate | — | 1.000 | — |
| total_paths | — | 11 | — |
| valid_paths | — | 11 | — |
| causal_paths_found | — | 1 | — |
| causal_valid_paths | — | 1 | — |
| causal_latency_ms | — | 0.295 | — |
...
| Metric | Value |
|--------|-------|
| create | count=100, success_rate=1.00, avg_latency_ms=13.10 |
| read | count=100, success_rate=1.00, avg_latency_ms=0.20 |
| search | count=20, hit_rate=0.00, avg_latency_ms=81.61 |
| update | count=20, success_rate=1.00, avg_latency_ms=8.51 |
| delete | count=10, success_rate=0.00, avg_latency_ms=0.00, search_gone_rate=1.00 |
| batch_create | count=50, success_rate=1.00, avg_latency_ms=350.45 |
| layer_migration | count=15, cross_layer_hit_rate=0.00, recall_hit_rate=0.00 |
| checkpoint_restore | count=10, cp1_hit_rate=0.00, cp1_persistence_rate=0.00, cp2_hit_rate=0.00 |
...
|--------|------|---------|-------|
| create.count | — | 100 | — |
| create.success_rate | — | 1.000 | — |
| create.avg_latency_ms | — | 13.095 | — |
| read.count | — | 100 | — |
| read.success_rate | — | 1.000 | — |
| read.avg_latency_ms | — | 0.204 | — |
| search.count | — | 20 | — |
| search.hit_rate | — | 0.000 | — |
| search.avg_latency_ms | — | 81.610 | — |
| update.count | — | 20 | — |
| update.success_rate | — | 1.000 | — |
| update.avg_latency_ms | — | 8.506 | — |
| delete.count | — | 10 | — |
| delete.success_rate | — | 0.000 | — |
| delete.avg_latency_ms | — | 0.001 | — |
| delete.search_gone_rate | — | 1.000 | — |
| batch_create.count | — | 50 | — |
| batch_create.success_rate | — | 1.000 | — |
| batch_create.avg_latency_ms | — | 350.447 | — |
| layer_migration.count | — | 15 | — |
| layer_migration.cross_layer_hit_rate | — | 0.000 | — |
| layer_migration.recall_hit_rate | — | 0.000 | — |
| checkpoint_restore.count | — | 10 | — |
| checkpoint_restore.cp1_hit_rate | — | 0.000 | — |
| checkpoint_restore.cp1_persistence_rate | — | 0.000 | — |
| checkpoint_restore.cp2_hit_rate | — | 0.000 | — |
| create.count | — | 100 | — |
| create.success_rate | — | 1.000 | — |
| create.avg_latency_ms | — | 3.531 | — |
| read.count | — | 100 | — |
| read.success_rate | — | 1.000 | — |
| read.avg_latency_ms | — | 0.086 | — |
| search.count | — | 20 | — |
| search.hit_rate | — | 0.950 | — |
| search.avg_latency_ms | — | 12.851 | — |
| update.count | — | 20 | — |
| update.success_rate | — | 1.000 | — |
| update.avg_latency_ms | — | 3.668 | — |
| delete.count | — | 10 | — |
| delete.success_rate | — | 1.000 | — |
| delete.avg_latency_ms | — | 0.638 | — |
| delete.search_gone_rate | — | 0.600 | — |
| batch_create.count | — | 50 | — |
| batch_create.success_rate | — | 1.000 | — |
| batch_create.avg_latency_ms | — | 403.171 | — |
| layer_migration.count | — | 15 | — |
| layer_migration.cross_layer_hit_rate | — | 0.333 | — |
| layer_migration.recall_hit_rate | — | 0.000 | — |
| layer_migration.accuracy_pct | — | 13.300 | — |
| checkpoint_restore.count | — | 10 | — |
| checkpoint_restore.cp1_hit_rate | — | 1.000 | — |
| checkpoint_restore.cp1_persistence_rate | — | 1.000 | — |
| checkpoint_restore.cp2_hit_rate | — | 1.000 | — |

### memory-lifecycle

| Metric | Value |
|--------|-------|
| create | count=100, success_rate=1.00, avg_latency_ms=3.53 |
| read | count=100, success_rate=1.00, avg_latency_ms=0.09 |
| search | count=20, hit_rate=0.95, avg_latency_ms=12.85 |
| update | count=20, success_rate=1.00, avg_latency_ms=3.67 |
| delete | count=10, success_rate=1.00, avg_latency_ms=0.64, search_gone_rate=0.60 |
| batch_create | count=50, success_rate=1.00, avg_latency_ms=403.17 |
...
| Metric | Value |
|--------|-------|
| cas_write | qps=21.30, p50_ms=17.34, p95_ms=26.52, p99_ms=1696.19 |
| search | qps=1375.50, p50_ms=0.08, p95_ms=0.15, p99_ms=0.56 |
| memory_recall | qps=2218.70, p50_ms=0.45, p95_ms=0.51, p99_ms=2.60 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| cas_write.qps | 24.900 | 21.300 | -3.600 |
| cas_write.p50_ms | 36.344 | 17.345 | -18.999 |
| cas_write.p95_ms | 76.246 | 26.518 | -49.728 |
| cas_write.p99_ms | 139.188 | 1696.189 | +1557.001 |
| search.qps | 3134.200 | 1375.500 | -1758.700 |
| search.p50_ms | 0.104 | 0.079 | -0.025 |
| search.p95_ms | 1.712 | 0.152 | -1.560 |
| search.p99_ms | 1.942 | 0.562 | -1.380 |
| memory_recall.qps | 2213.400 | 2218.700 | +5.300 |
| memory_recall.p50_ms | 0.342 | 0.446 | +0.104 |
| memory_recall.p95_ms | 1.801 | 0.513 | -1.289 |
| memory_recall.p99_ms | 1.997 | 2.602 | +0.604 |
| cas_write.qps | 24.900 | 217.800 | +192.900 |
| cas_write.p50_ms | 36.344 | 3.721 | -32.623 |
| cas_write.p95_ms | 76.246 | 9.451 | -66.795 |
| cas_write.p99_ms | 139.188 | 27.098 | -112.090 |
| search.qps | 3134.200 | 2824.800 | -309.400 |
| search.p50_ms | 0.104 | 0.226 | +0.122 |
| search.p95_ms | 1.712 | 0.445 | -1.268 |
| search.p99_ms | 1.942 | 0.483 | -1.459 |
| memory_recall.qps | 2213.400 | 8218.200 | +6004.800 |
| memory_recall.p50_ms | 0.342 | 0.082 | -0.260 |
| memory_recall.p95_ms | 1.801 | 0.126 | -1.675 |
| memory_recall.p99_ms | 1.997 | 2.340 | +0.343 |

### performance

| Metric | Value |
|--------|-------|
| cas_write | qps=217.80, p50_ms=3.72, p95_ms=9.45, p99_ms=27.10 |
| search | qps=2824.80, p50_ms=0.23, p95_ms=0.44, p99_ms=0.48 |
| memory_recall | qps=8218.20, p50_ms=0.08, p95_ms=0.13, p99_ms=2.34 |
| kg_path | qps=None, p50_ms=None, p95_ms=None, p99_ms=None |
...
| context_l1 | avg_tokens_per_query=352.40, hit_rate=1.00, pct_of_full=1.35 |
| context_l2 | avg_tokens_per_query=1058.80, hit_rate=1.00, pct_of_full=4.07 |
| repeated_query_latency | cold_avg_ms=40.51, warm_avg_ms=0.27, speedup_pct=99.30, cache_bust_queries=10 |
| pattern_detection | items_created=30, search_hits=20, recall_hits=0, search_recall_rate=0.67 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| context_l0.avg_tokens_per_query | — | 113.000 | — |
| context_l0.hit_rate | — | 1.000 | — |
| context_l0.pct_of_full | — | 0.430 | — |
| context_l1.avg_tokens_per_query | — | 352.400 | — |
| context_l1.hit_rate | — | 1.000 | — |
| context_l1.pct_of_full | — | 1.350 | — |
| context_l2.avg_tokens_per_query | — | 1058.800 | — |
| context_l2.hit_rate | — | 1.000 | — |
| context_l2.pct_of_full | — | 4.070 | — |
| repeated_query_latency.cold_avg_ms | — | 40.510 | — |
| repeated_query_latency.warm_avg_ms | — | 0.270 | — |
| repeated_query_latency.speedup_pct | — | 99.300 | — |
| repeated_query_latency.cache_bust_queries | — | 10 | — |
| pattern_detection.items_created | — | 30 | — |
| pattern_detection.search_hits | — | 20 | — |
| pattern_detection.recall_hits | — | 0 | — |
| pattern_detection.search_recall_rate | — | 0.667 | — |
| context_l0.avg_tokens_per_query | — | 113.000 | — |
| context_l0.hit_rate | — | 1.000 | — |
| context_l0.pct_of_full | — | 0.430 | — |
| context_l1.avg_tokens_per_query | — | 352.400 | — |
| context_l1.hit_rate | — | 1.000 | — |
| context_l1.pct_of_full | — | 1.350 | — |
| context_l2.avg_tokens_per_query | — | 1148.000 | — |
| context_l2.hit_rate | — | 1.000 | — |
| context_l2.pct_of_full | — | 4.410 | — |
| repeated_query_latency.cold_avg_ms | — | 18.040 | — |
| repeated_query_latency.warm_avg_ms | — | 0.110 | — |
| repeated_query_latency.speedup_pct | — | 99.400 | — |
| repeated_query_latency.cache_bust_queries | — | 10 | — |
| pattern_detection.items_created | — | 30 | — |
| pattern_detection.search_hits | — | 20 | — |
| pattern_detection.recall_hits | — | 0 | — |
...
| context_l0 | avg_tokens_per_query=113.00, hit_rate=1.00, pct_of_full=0.43 |
| context_l1 | avg_tokens_per_query=352.40, hit_rate=1.00, pct_of_full=1.35 |
| context_l2 | avg_tokens_per_query=1148.00, hit_rate=1.00, pct_of_full=4.41 |
| repeated_query_latency | cold_avg_ms=18.04, warm_avg_ms=0.11, speedup_pct=99.40, cache_bust_queries=10 |
| pattern_detection | items_created=30, search_hits=20, recall_hits=0, search_recall_rate=0.67 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| beir_scifact.count | — | 30 | — |
| beir_scifact.recall@5 | — | 0.557 | — |
| beir_scifact.recall@10 | — | 0.770 | — |

### retrieval

| Metric | Value |
|--------|-------|
| beir_scifact | count=30, recall@5=0.56, recall@10=0.77 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| private_isolation.count | — | 30 | — |
| private_isolation.leak_rate | — | 0.000 | — |
| private_isolation.own_access_rate | — | 0.000 | — |
| private_isolation.isolation_perfect | — | True | — |
| shared_access.count | — | 30 | — |
| shared_access.cross_agent_access_rate | — | 0.000 | — |
| group_isolation.count | — | 30 | — |
| group_isolation.outsider_leak_rate | — | 0.000 | — |
| group_isolation.isolation_perfect | — | True | — |
| multi_group_isolation.alpha_to_beta_leaks | — | 0 | — |
| multi_group_isolation.beta_to_alpha_leaks | — | 0 | — |
| multi_group_isolation.total_leak_rate | — | 0.000 | — |
| multi_group_isolation.isolation_perfect | — | True | — |
| recall_isolation.count | — | 5 | — |
| recall_isolation.cross_agent_leaks | — | 0 | — |
| recall_isolation.own_recall_hits | — | 0 | — |
| recall_isolation.isolation_perfect | — | True | — |
| private_isolation.count | — | 30 | — |
| private_isolation.leak_rate | — | 0.667 | — |
| private_isolation.own_access_rate | — | 0.200 | — |
| private_isolation.isolation_perfect | — | False | — |
| shared_access.count | — | 30 | — |
| shared_access.cross_agent_access_rate | — | 0.000 | — |
| group_isolation.count | — | 30 | — |
| group_isolation.outsider_leak_rate | — | 0.100 | — |
| group_isolation.isolation_perfect | — | False | — |
| multi_group_isolation.alpha_to_beta_leaks | — | 0 | — |
| multi_group_isolation.beta_to_alpha_leaks | — | 0 | — |
| multi_group_isolation.total_leak_rate | — | 0.000 | — |
| multi_group_isolation.isolation_perfect | — | True | — |
...
| Metric | Value |
|--------|-------|
| private_isolation | count=30, leak_rate=0.67, own_access_rate=0.20, isolation_perfect=False |
| shared_access | count=30, cross_agent_access_rate=0.00 |
| group_isolation | count=30, outsider_leak_rate=0.10, isolation_perfect=False |
| multi_group_isolation | alpha_to_beta_leaks=0, beta_to_alpha_leaks=0, total_leak_rate=0.00, isolation_perfect=True |
| recall_isolation | count=5, cross_agent_leaks=0, own_recall_hits=0, isolation_perfect=True |
...
| Metric | Value |
|--------|-------|
| session_lifecycle | count=20, success_rate=0.00, avg_start_latency_ms=127.93, avg_end_latency_ms=0 |
...
| warm_context_delta | session1_items=10, cross_session_hit_rate=0.00, assembly_latency_ms=138.17 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| session_lifecycle.count | — | 20 | — |
| session_lifecycle.success_rate | — | 0.000 | — |
| session_lifecycle.avg_start_latency_ms | — | 127.926 | — |
| session_lifecycle.avg_end_latency_ms | — | 0 | — |
| cross_session_memory.count | — | 10 | — |
| cross_session_memory.search_persistence_rate | — | 0.000 | — |
| cross_session_memory.recall_persistence_rate | — | 0.000 | — |
| session_vs_persistent.count | — | 5 | — |
| session_vs_persistent.working_memory_persistence | — | 0.000 | — |
| session_vs_persistent.longterm_memory_persistence | — | 0.000 | — |
| warm_context_delta.session1_items | — | 10 | — |
| warm_context_delta.cross_session_hit_rate | — | 0.000 | — |
| warm_context_delta.assembly_latency_ms | — | 138.174 | — |
| session_lifecycle.count | — | 20 | — |
| session_lifecycle.success_rate | — | 1.000 | — |
| session_lifecycle.avg_start_latency_ms | — | 43.452 | — |
| session_lifecycle.avg_end_latency_ms | — | 1.429 | — |
| cross_session_memory.count | — | 10 | — |
| cross_session_memory.search_persistence_rate | — | 0.200 | — |
| cross_session_memory.recall_persistence_rate | — | 0.000 | — |
| session_vs_persistent.count | — | 5 | — |
| session_vs_persistent.working_memory_persistence | — | 0.000 | — |
| session_vs_persistent.longterm_memory_persistence | — | 0.000 | — |
| warm_context_delta.session1_items | — | 10 | — |
| warm_context_delta.cross_session_hit_rate | — | 0.200 | — |
| warm_context_delta.assembly_latency_ms | — | 34.038 | — |

### session-lifecycle

| Metric | Value |
|--------|-------|
| session_lifecycle | count=20, success_rate=1.00, avg_start_latency_ms=43.45, avg_end_latency_ms=1.43 |
| cross_session_memory | count=10, search_persistence_rate=0.20, recall_persistence_rate=0.00 |
| session_vs_persistent | count=5, working_memory_persistence=0.00, longterm_memory_persistence=0.00 |
| warm_context_delta | session1_items=10, cross_session_hit_rate=0.20, assembly_latency_ms=34.04 |
...
| Metric | Value |
|--------|-------|
| context_l0 | avg_tokens_per_query=350.00, pct_of_full_context=1.34, vs_memori_ratio=0.27 |
| context_l1 | avg_tokens_per_query=575.80, pct_of_full_context=2.21, vs_memori_ratio=0.44 |
| context_l2 | avg_tokens_per_query=1689.80, pct_of_full_context=6.49, vs_memori_ratio=1.31 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| context_l0.avg_tokens_per_query | — | 350.000 | — |
| context_l0.pct_of_full_context | — | 1.340 | — |
| context_l0.vs_memori_ratio | — | 0.270 | — |
| context_l1.avg_tokens_per_query | — | 575.800 | — |
| context_l1.pct_of_full_context | — | 2.210 | — |
| context_l1.vs_memori_ratio | — | 0.440 | — |
| context_l2.avg_tokens_per_query | — | 1689.800 | — |
| context_l2.pct_of_full_context | — | 6.490 | — |
| context_l2.vs_memori_ratio | — | 1.310 | — |
| recall_efficiency.avg_tokens_per_query | — | 0.000 | — |
| recall_efficiency.pct_of_full_context | — | 0.000 | — |
| recall_efficiency.vs_memori_ratio | — | 0.000 | — |
| context_l0.avg_tokens_per_query | — | 312.500 | — |
| context_l0.pct_of_full_context | — | 1.200 | — |
| context_l0.vs_memori_ratio | — | 0.240 | — |
| context_l1.avg_tokens_per_query | — | 571.600 | — |
| context_l1.pct_of_full_context | — | 2.200 | — |
| context_l1.vs_memori_ratio | — | 0.440 | — |
| context_l2.avg_tokens_per_query | — | 2492.400 | — |
| context_l2.pct_of_full_context | — | 9.570 | — |
| context_l2.vs_memori_ratio | — | 1.930 | — |
| recall_efficiency.avg_tokens_per_query | — | 0.000 | — |
| recall_efficiency.pct_of_full_context | — | 0.000 | — |
| recall_efficiency.vs_memori_ratio | — | 0.000 | — |
...
| Metric | Value |
|--------|-------|
| context_l0 | avg_tokens_per_query=312.50, pct_of_full_context=1.20, vs_memori_ratio=0.24 |
| context_l1 | avg_tokens_per_query=571.60, pct_of_full_context=2.20, vs_memori_ratio=0.44 |
| context_l2 | avg_tokens_per_query=2492.40, pct_of_full_context=9.57, vs_memori_ratio=1.93 |
| recall_efficiency | avg_tokens_per_query=0.00, pct_of_full_context=0.00, vs_memori_ratio=0.00 |
...
|---|-------|----------|--------|-------|
| A1 | token_scarcity | token-efficiency | 350 tok/query (under Memori) | 2/2 |
| A2 | intent_before_action | intent-routing, conversational-qa | accuracy 30.0% | 0/2 |
...
| A6 | semantics_before_structure | retrieval | measured | 1/2 |
...
| A9 | gets_better | memory-lifecycle | persistence 0% | 0/2 |
| A10 | session_first_class | session-lifecycle | session success 0% | 0/2 |
| | **Total** | | | **8/20** |
