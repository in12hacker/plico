...
|-------|-----------|-------|----------------|-----|
| causal-reasoning | cause_finds_effect | 1.000 | — | — |
| conversational-qa | accuracy_pct | 42.500 | 95.4 (OMEGA) | -52.9 |
| intent-routing | avg_intent_hit | 0.664 | — | — |
| kg-reasoning | avg_latency_ms | 0.174 | — | — |
| memory-lifecycle | create.success_rate | 1.000 | — | — |
| performance | search.p50_ms | 328.292 | — | — |
| proactive-optimization | L0.avg_tokens | 113.000 | — | — |
| retrieval | beir_scifact.recall@5 | 0.687 | 72.31 (NV-Embed-v2) | -71.6 |
| scope-isolation | leak_rate | 0.000 | — | — |
| scope-isolation | leak_rate | 0.000 | — | — |
| session-lifecycle | success_rate | 1.000 | — | — |
| token-efficiency | context_l0.avg_tokens | 630.800 | 1294 (Memori) | -663.2 |
...
| Metric | Value |
|--------|-------|
| causal_chain_construction | count=30, avg_node_latency_ms=0.36 |
| causal_path_depth_2 | paths_found=1, latency_ms=0.70 |
| causal_path_depth_3 | paths_found=2, latency_ms=0.22 |
| causal_path_depth_4 | paths_found=5, latency_ms=0.30 |
| causal_path_depth_10 | paths_found=9, latency_ms=0.22 |
| causal_retrieval | count=5, cause_finds_effect_rate=1.00, effect_finds_cause_rate=0.80, bidirectional_rate=0.90, accuracy_pct=0.00 |
...
| causal_chain_construction.avg_node_latency_ms | 0.698 | 0.363 | -0.335 |
| causal_path_depth_2.paths_found | 1 | 1 | = |
| causal_path_depth_2.latency_ms | 0.254 | 0.699 | +0.445 |
| causal_path_depth_3.paths_found | 2 | 2 | = |
| causal_path_depth_3.latency_ms | 0.265 | 0.222 | -0.042 |
| causal_path_depth_4.paths_found | 5 | 5 | = |
| causal_path_depth_4.latency_ms | 0.243 | 0.296 | +0.053 |
| causal_path_depth_10.paths_found | 9 | 9 | = |
| causal_path_depth_10.latency_ms | 0.497 | 0.225 | -0.272 |
| causal_retrieval.count | 5 | 5 | = |
| causal_retrieval.cause_finds_effect_rate | 0.000 | 1.000 | +1.000 |
| causal_retrieval.effect_finds_cause_rate | 0.000 | 0.800 | +0.800 |
| causal_retrieval.bidirectional_rate | 0.000 | 0.900 | +0.900 |
...
| answer_relevancy | 0.750 | 0.80 (-0.05) |
| context_precision | 0.650 | 0.65 (+0.00) |
| context_recall | 0.550 | 0.75 (-0.20) |
...
|--------|------|---------|-------|
| count | 40 | 40 | = |
| f1 | 0.204 | 0.252 | +0.049 |
| bleu1 | 0.165 | 0.206 | +0.041 |
| llm_score | 2.225 | 2.850 | +0.625 |
| accuracy_pct | 30.000 | 42.500 | +12.500 |
| context_hit_rate | 1.000 | 1.000 | = |
| mean | 0.204 | 0.252 | +0.049 |
| std | 0.330 | 0.344 | +0.015 |
| ci95_low | 0.101 | 0.146 | +0.044 |
| ci95_high | 0.306 | 0.359 | +0.053 |

### intent-routing

| Metric | Value |
|--------|-------|
| intent_factual | query_count=5, hit_rate=0.40, accuracy_pct=0.00, avg_latency_ms=491.49 |
| intent_temporal | query_count=5, hit_rate=0.60, accuracy_pct=0.00, avg_latency_ms=502.51 |
| intent_multi_hop | query_count=5, hit_rate=0.92, accuracy_pct=20.00, avg_latency_ms=527.80 |
| intent_preference | query_count=5, hit_rate=0.80, accuracy_pct=0.00, avg_latency_ms=611.17 |
| intent_aggregation | query_count=5, hit_rate=0.60, accuracy_pct=0.00, avg_latency_ms=517.62 |
...
| intent_factual.avg_latency_ms | 96.520 | 491.490 | +394.970 |
...
| intent_aggregation.avg_latency_ms | 100.970 | 517.620 | +416.650 |
...
| avg_latency_ms | 0.356 | 0.174 | -0.182 |
| path_validity_rate | 1.000 | 1.000 | = |
| total_paths | 11 | 11 | = |
| valid_paths | 11 | 11 | = |
| causal_paths_found | 1 | 1 | = |
| causal_valid_paths | 1 | 1 | = |
| causal_latency_ms | 0.258 | 0.054 | -0.203 |

### memory-lifecycle

| Metric | Value |
|--------|-------|
| create | count=100, success_rate=1.00, avg_latency_ms=3.42 |
| read | count=100, success_rate=1.00, avg_latency_ms=0.09 |
| search | count=20, hit_rate=1.00, avg_latency_ms=139.12 |
| update | count=20, success_rate=1.00, avg_latency_ms=3.62 |
| delete | count=10, success_rate=1.00, avg_latency_ms=0.08, search_gone_rate=0.00 |
| batch_create | count=50, success_rate=1.00, avg_latency_ms=368.74 |
| layer_migration | count=15, cross_layer_hit_rate=0.33, recall_hit_rate=0.00, accuracy_pct=6.70 |
...
| create.avg_latency_ms | 13.095 | 3.416 | -9.679 |
| read.count | 100 | 100 | = |
| read.success_rate | 1.000 | 1.000 | = |
| read.avg_latency_ms | 0.204 | 0.087 | -0.117 |
| search.count | 20 | 20 | = |
| search.hit_rate | 0.000 | 1.000 | +1.000 |
| search.avg_latency_ms | 81.610 | 139.124 | +57.514 |
| update.count | 20 | 20 | = |
| update.success_rate | 1.000 | 1.000 | = |
| update.avg_latency_ms | 8.506 | 3.624 | -4.882 |
| delete.count | 10 | 10 | = |
| delete.success_rate | 0.000 | 1.000 | +1.000 |
| delete.avg_latency_ms | 0.001 | 0.084 | +0.083 |
| delete.search_gone_rate | 1.000 | 0.000 | -1.000 |
| batch_create.count | 50 | 50 | = |
| batch_create.success_rate | 1.000 | 1.000 | = |
| batch_create.avg_latency_ms | 350.447 | 368.735 | +18.288 |
...
| layer_migration.accuracy_pct | 13.300 | 6.700 | -6.600 |
...
| Metric | Value |
|--------|-------|
| cas_write | qps=177.10, p50_ms=4.02, p95_ms=16.32, p99_ms=28.29 |
| search | qps=2.70, p50_ms=328.29, p95_ms=403.55, p99_ms=546.97 |
| memory_recall | qps=11482.10, p50_ms=0.08, p95_ms=0.10, p99_ms=0.28 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| cas_write.qps | 21.300 | 177.100 | +155.800 |
| cas_write.p50_ms | 17.345 | 4.024 | -13.321 |
| cas_write.p95_ms | 26.518 | 16.321 | -10.196 |
| cas_write.p99_ms | 1696.189 | 28.288 | -1667.901 |
| search.qps | 1375.500 | 2.700 | -1372.800 |
| search.p50_ms | 0.079 | 328.292 | +328.214 |
| search.p95_ms | 0.152 | 403.550 | +403.397 |
| search.p99_ms | 0.562 | 546.971 | +546.409 |
| memory_recall.qps | 2218.700 | 11482.100 | +9263.400 |
| memory_recall.p50_ms | 0.446 | 0.081 | -0.365 |
| memory_recall.p95_ms | 0.513 | 0.100 | -0.412 |
| memory_recall.p99_ms | 2.602 | 0.284 | -2.318 |
...
| repeated_query_latency | cold_avg_ms=539.85, warm_avg_ms=513.02, speedup_pct=5.00, cache_bust_queries=10 |
...
| repeated_query_latency.cold_avg_ms | 40.510 | 539.850 | +499.340 |
| repeated_query_latency.warm_avg_ms | 0.270 | 513.020 | +512.750 |
| repeated_query_latency.speedup_pct | 99.300 | 5.000 | -94.300 |
...
| Metric | Value |
|--------|-------|
| beir_scifact | count=30, recall@5=0.69, recall@10=0.73 |
...
| beir_scifact.recall@5 | 0.557 | 0.687 | +0.130 |
| beir_scifact.recall@10 | 0.770 | 0.727 | -0.043 |

### scope-isolation

| Metric | Value |
|--------|-------|
| private_isolation | count=30, leak_rate=0.00, own_access_rate=1.00, isolation_perfect=True |
| shared_access | count=30, cross_agent_access_rate=1.00 |
...
| private_isolation.own_access_rate | 0.000 | 1.000 | +1.000 |
| private_isolation.isolation_perfect | True | True | = |
| shared_access.count | 30 | 30 | = |
| shared_access.cross_agent_access_rate | 0.000 | 1.000 | +1.000 |
...
| private_isolation.count | 30 | 10 | -20.000 |
| private_isolation.leak_rate | 0.000 | 0.000 | = |
| private_isolation.own_access_rate | 0.000 | 1.000 | +1.000 |
| private_isolation.isolation_perfect | True | True | = |
| shared_access.count | 30 | 10 | -20.000 |
| shared_access.cross_agent_access_rate | 0.000 | 1.000 | +1.000 |
| group_isolation.count | 30 | 10 | -20.000 |
| group_isolation.outsider_leak_rate | 0.000 | 0.000 | = |
| group_isolation.isolation_perfect | True | True | = |
| multi_group_isolation.alpha_to_beta_leaks | 0 | 0 | = |
| multi_group_isolation.beta_to_alpha_leaks | 0 | 0 | = |
...
| Metric | Value |
|--------|-------|
| private_isolation | count=10, leak_rate=0.00, own_access_rate=1.00, isolation_perfect=True |
| shared_access | count=10, cross_agent_access_rate=1.00 |
| group_isolation | count=10, outsider_leak_rate=0.00, isolation_perfect=True |
| multi_group_isolation | alpha_to_beta_leaks=0, beta_to_alpha_leaks=0, total_leak_rate=0.00, isolation_perfect=True |
| recall_isolation | count=5, cross_agent_leaks=0, own_recall_hits=0, isolation_perfect=True |
...
| Metric | Value |
|--------|-------|
| session_lifecycle | count=20, success_rate=1.00, avg_start_latency_ms=40.51, avg_end_latency_ms=0.68 |
| cross_session_memory | count=10, search_persistence_rate=1.00, recall_persistence_rate=0.00 |
| session_vs_persistent | count=5, working_memory_persistence=0.00, longterm_memory_persistence=0.00 |
| warm_context_delta | session1_items=10, cross_session_hit_rate=1.00, assembly_latency_ms=39.13 |
...
| session_lifecycle.avg_start_latency_ms | 127.926 | 40.506 | -87.420 |
| session_lifecycle.avg_end_latency_ms | 0 | 0.676 | +0.676 |
| cross_session_memory.count | 10 | 10 | = |
| cross_session_memory.search_persistence_rate | 0.000 | 1.000 | +1.000 |
...
| warm_context_delta.cross_session_hit_rate | 0.000 | 1.000 | +1.000 |
| warm_context_delta.assembly_latency_ms | 138.174 | 39.126 | -99.048 |

### token-efficiency

| Metric | Value |
|--------|-------|
| context_l0 | avg_tokens_per_query=630.80, pct_of_full_context=2.42, vs_memori_ratio=0.49 |
| context_l1 | avg_tokens_per_query=1058.80, pct_of_full_context=4.07, vs_memori_ratio=0.82 |
| context_l2 | avg_tokens_per_query=1864.30, pct_of_full_context=7.16, vs_memori_ratio=1.44 |
...
| Metric | Prev | Current | Delta |
|--------|------|---------|-------|
| context_l0.avg_tokens_per_query | 350.000 | 630.800 | +280.800 |
| context_l0.pct_of_full_context | 1.340 | 2.420 | +1.080 |
| context_l0.vs_memori_ratio | 0.270 | 0.490 | +0.220 |
| context_l1.avg_tokens_per_query | 575.800 | 1058.800 | +483.000 |
| context_l1.pct_of_full_context | 2.210 | 4.070 | +1.860 |
| context_l1.vs_memori_ratio | 0.440 | 0.820 | +0.380 |
| context_l2.avg_tokens_per_query | 1689.800 | 1864.300 | +174.500 |
| context_l2.pct_of_full_context | 6.490 | 7.160 | +0.670 |
| context_l2.vs_memori_ratio | 1.310 | 1.440 | +0.130 |
...
|---|-------|----------|--------|-------|
| A1 | token_scarcity | token-efficiency | 631 tok/query (under Memori) | 2/2 |
| A2 | intent_before_action | intent-routing, conversational-qa | accuracy 42.5% | 1/2 |
...
| A6 | semantics_before_structure | retrieval | beir_scifact recall@5 0.687 | 1/2 |
| A7 | proactive_before_passive | proactive-optimization | L0 113 tok, 100% hit | 2/2 |
| A8 | causality_before_correlation | causal-reasoning | causal retrieval 100% | 2/2 |
