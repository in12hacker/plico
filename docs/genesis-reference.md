# Plico 太初 — AI-OS 历史参考快照

**版本**: Genesis (Node 25)
**日期**: 2026-04-24
**灵魂**: `system-v2.md` (Soul 2.0，当时版本)
**代码**: 132 files | 50,487 lines | 1,435 tests

> 本文档封存 Plico 从 Node 1 到 Node 25 的设计决策、API 与架构，是 2026-04-24 的历史快照，
> 取代当时散布在 24 份 Node 设计文档中的碎片化信息。它不是当前实现规范，文件数、测试数、
> API、provider 和命令均不得作为现状声明。当前规范依次以 `system-v3.md`、已接受 ADR、
> `AGENTS.md` 和模块 `INDEX.md` 为准。
...
*本文档封存于 2026-04-24，基于当时 132 个源文件的代码扫描和 1,435 项测试验证。*
