...
pub(crate) const PLICO_ACTIONS: &[ActionMeta] = &[
    ...
    ActionMeta { name: "kg_add_node", description: "Add a node to the knowledge graph", params: &[("label", "Node label", true), ("node_type", "entity|fact|document|agent|memory", false), ("properties", "JSON properties object", false), ("agent_id", "Agent identifier", true)], is_write: true },
    ActionMeta { name: "kg_add_edge", description: "Add an edge between two KG nodes", params: &[("src_id", "Source node ID", true), ("dst_id", "Destination node ID", true), ("edge_type", "causes|related_to|similar_to|part_of|mentions|follows|associates_with|reminds", false), ("weight", "Edge weight 0.0-1.0", false), ("agent_id", "Agent identifier", true)], is_write: true },
    ActionMeta { name: "kg_find_paths", description: "Find paths between two KG nodes", params: &[("src_id", "Source node ID", true), ("dst_id", "Destination node ID", true), ("max_depth", "Maximum path depth", false), ("weighted", "Use weighted pathfinding", false), ("agent_id", "Agent identifier", true)], is_write: false },
    ActionMeta { name: "kg_causal_path", description: "Find causal chain between two nodes", params: &[("from_id", "Cause node ID", true), ("to_id", "Effect node ID", true), ("depth", "Max depth", false), ("agent_id", "Agent identifier", true)], is_write: false },
    ActionMeta { name: "kg_impact", description: "Analyze impact of a node (all downstream paths)", params: &[("node_id", "Node to analyze", true), ("depth", "Max depth", false), ("agent_id", "Agent identifier", true)], is_write: false },
    ActionMeta { name: "kg_list_nodes", description: "List KG nodes, optionally filtered by type", params: &[("node_type", "Filter: entity|fact|document|agent|memory", false), ("agent_id", "Agent identifier", true)], is_write: false },
    ActionMeta { name: "kg_list_edges", description: "List all KG edges", params: &[("agent_id", "Agent identifier", true)], is_write: false },
    ActionMeta { name: "batch_create", description: "Batch store multiple items to CAS", params: &[("items", "Array of {content, tags?, intent?}", true), ("agent_id", "Agent identifier", true)], is_write: true },
    ActionMeta { name: "batch_remember", description: "Batch store multiple items to long-term memory", params: &[("items", "Array of {content, tags?, importance?}", true), ("agent_id", "Agent identifier", true)], is_write: true },
    ActionMeta { name: "context_assemble", description: "Assemble context from CIDs with token budget", params: &[("cids", "Array of {cid, relevance?}", true), ("token_budget", "Max tokens", false), ("agent_id", "Agent identifier", true)], is_write: false },
