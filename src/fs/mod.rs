...
pub use embedding::{EmbeddingProvider, Embedding, EmbeddingMeta, EmbedError, EmbedResult, OllamaBackend, OpenAIEmbeddingBackend, LocalEmbeddingBackend, StubEmbeddingProvider, OrtEmbeddingBackend, EmbeddingCircuitBreaker};
