//! The single pure attempt-state reducer (ADR-0009).
//!
...
#[derive(Debug)]
pub(super) enum ReducibleKindV1 {
    Started {
...
#[derive(Debug)]
pub(super) struct ReducibleEventV1 {
    ...
    pub(super) key: ExecutionAttemptKeyV1,
    pub(super) kind: ReducibleKindV1,
}

/// The receipt-bearing facts one stored event contributes to an attempt.
#[derive(Debug)]
pub(super) struct ReducibleReceiptV1 {
    pub(super) request_sha256: String,
    pub(super) event_sha256: String,
    pub(super) sequence: u64,
    pub(super) root_generation: u64,
...
#[derive(Debug)]
pub(super) struct ReducibleAttemptV1 {
    pub(super) key: ExecutionAttemptKeyV1,
    pub(super) started: ReducibleReceiptV1,
    pub(super) terminal: Option<ReducibleReceiptV1>,
}
...
pub(super) fn attempt_ordering(attempt: &ReducibleAttemptV1, needle: ([u8; 16], u32)) -> Ordering {
...
pub(super) fn reduce(events: Vec<ReducibleEventV1>) -> Result<Vec<ReducibleAttemptV1>, ObservationStoreError> {
